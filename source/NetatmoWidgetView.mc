...
class NetatmoWidgetView extends Ui.View {
    ...
    function onUpdate(dc) {
        ...
        View.onUpdate(dc);
        netatmo.user_preferences = new UserPreferences();
        Sys.println(Ui.loadResource( Rez.Strings.Pressure ));
      ...
      //display C02
        ...
        dc.drawText((dc.getWidth() / 3)*2+10, (dc.getHeight()  /10)+15, Gfx.FONT_SYSTEM_XTINY, netatmo.interior_datas.pressure.format("%.1f")+netatmo.user_preferences.pressureunit, Gfx.TEXT_JUSTIFY_CENTER);
